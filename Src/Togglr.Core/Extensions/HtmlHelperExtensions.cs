...
namespace Togglr.Extensions
{
    public static class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString PartialAsFeature<T>(this HtmlHelper<T> htmlHelper, string partialViewName, IFeatureToggle featureToggle)
        {
            return PartialAsFeature(htmlHelper, partialViewName, null, htmlHelper.ViewData, featureToggle);
        }

        public static MvcHtmlString PartialAsFeature<T>(this HtmlHelper<T> htmlHelper, string partialViewName, ViewDataDictionary viewData, IFeatureToggle featureToggle)
        {
            return PartialAsFeature(htmlHelper, partialViewName, null, viewData, featureToggle);
        }

        public static MvcHtmlString PartialAsFeature<T>(this HtmlHelper<T> htmlHelper, string partialViewName, object model, IFeatureToggle featureToggle)
        {
            return PartialAsFeature(htmlHelper, partialViewName, model, htmlHelper.ViewData, featureToggle);
        }

        public static MvcHtmlString PartialAsFeature<T>(this HtmlHelper<T> htmlHelper, string partialViewName, object model, ViewDataDictionary viewData, IFeatureToggle featureToggle)
        {
            return featureToggle.IsEnabled ? htmlHelper.Partial(partialViewName, model, viewData) : MvcHtmlString.Empty;
        }
        ...
        public static bool IsFeatureEnabled<T>(this HtmlHelper<T> htmlHelper, IFeatureToggle featureToggle)
        {
            return featureToggle.IsEnabled;
        }
    }
